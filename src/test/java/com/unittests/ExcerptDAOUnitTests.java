...
class ExcerptDAOUnitTests {
	...
	Excerpt wilde2 = new Excerpt(3, "Oscar Wilde", "De Profundis",
			"Most people are other people. Their thoughts are someone else's opinions, their lives a mimicry, their passions a quotation.",
			"comment no 3");
	Excerpt pinter1 = new Excerpt(4, "Harold Pinter", "The Homecoming",
			"The earth's about five million years old, at least. Who can afford to live in the past?", "comment no 4");
	Excerpt bradbury = new Excerpt(5, "Ray Bradbury", "The Homecoming",
			"If you hide your ignorance, no one will hit you and you'll never learn.", "comment no 5");
	Excerpt pinter2 = new Excerpt(6, "Harold Pinter", "The Homecoming",
	...
	@Test
	public void shouldGetAllExcerpts() throws Exception {
	...
	@Test
	public void shouldCountAllExcerpt() throws Exception {
	...
	@Test
	public void shouldDeleteExcerpt() {
